...
## Quality Bar for Video Ideas
A video idea is only acceptable if:
- The title contains a specific number, timeframe, or concrete claim (e.g. "I Tested X for 30 Days", "Why 90% of People Get X Wrong")
- The hook describes a specific scene or statement, not a generic promise
- Bad example: "Discover personalized morning routines for entrepreneurs!"
- Good example: "I followed Elon Musk's 5am routine for 2 weeks. My productivity doubled — here's what happened."

## On Transcript Analysis
After reading each transcript, explicitly note:
- The first 30 seconds verbatim hook
- What problem the creator promises to solve
